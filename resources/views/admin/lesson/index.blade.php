                                ...
                                <td class="text-right">
                                    <div class="btn-group text-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                                <a href="{{ action('Admin\LessonController@edit', $row->id) }}">
                                                    Sửa
                                                </a>
                                            </li>
                                            <li>
                                                {!! Form::open(['method' => 'delete', 'action' => ['Admin\LessonController@destroy', $row->id], 'id' => 'row-' . $row->id]) !!}
                                                {!! Form::close() !!}
...
function confirm_delete() {
    var ok = confirm('Bạn chắc chắn muốn xóa bài học này?');
