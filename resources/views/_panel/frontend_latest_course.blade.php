        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="col-item">
                    ...
                    <div class="photo">
                        <a href="#"><img src="{{ asset('frontend/img/poetry.jpg') }}" alt="" /></a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="col-item">
                    <div class="photo">
                        <a href="#"><img src="{{ asset('frontend/img/business.jpg') }}" alt="" /></a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="col-item">
                    <div class="photo">
                        <a href="#"><img src="{{ asset('frontend/img/art.jpg') }}" alt="" /></a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="col-item">
                    <div class="photo">
                        <a href="#"><img src="{{ asset('frontend/img/math.jpg') }}" alt="" /></a>
