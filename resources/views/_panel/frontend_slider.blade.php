    ...
    <div class="tp-banner" >
        <ul class="sliderwrapper">	<!-- SLIDE  -->
            <li data-transition="fade" data-slotamount="4" data-masterspeed="1500" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('frontend/sliderimages/slide_5.jpg') }}" alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
                ...
                <div class="tp-caption skewfromrightshort customout"
                     ...
                     style="z-index: 2"><img src="{{ asset('frontend/sliderimages/logo.png') }}" alt="">
                </div>
            ...
            <li data-transition="zoomout" data-slotamount="4" data-masterspeed="1000" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('frontend/sliderimages/slide_6.jpg') }}" alt="slidebg2"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
            ...
            <li data-transition="cube-horizontal" data-slotamount="4" data-masterspeed="1000" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('frontend/sliderimages/slide_1.jpg') }}" alt="slidebg3"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
            ...
            <li data-transition="zoomin" data-slotamount="4" data-masterspeed="1000" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('frontend/sliderimages/slide_7.jpg') }}" alt="slidebg4"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
