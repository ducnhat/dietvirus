                                ...
                                <tr>
                                    <td class="mini-block">
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td class="code-block">
                                                    {{ $keyWarranty->productKey->getNewProductKey()->key }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="button">
                                                    <div><!--[if mso]>
                                                        ...
                                                        <![endif]--><a class="button-mobile" href="http://"
                                                                       style="background-color:#4a89dc;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Shop Now</a></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td style="padding: 25px 0 25px">
                            <strong><a href="http://phanmemquetvirut.com">Phanmemquetvirut.com</a></strong>
                        </td>
                    </tr>
                </table>
            </center>
